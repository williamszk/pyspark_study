"""Find the graph distance between nodes"""
...
lines = sc.textFile("./datasets/Marvel-Graph.txt")
type(lines)
lines.take(1)

# Character we wish to find degree of separation between:
...
def bfsMap(node):
    ...
    if color == "GRAY":
        ...
        # We've processed this node, so color is black
        color = "BLACK"
